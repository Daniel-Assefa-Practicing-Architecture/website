            ...
            <div key={id ? `item-${id}-${index}` : `item-grid-${index}`}>
              <div className={(twMerge('flex flex-row max-w-md'), panelClass)}>
                ...
                <div className="mt-0.5">
                  {title && (
                    <h3 className={twMerge('text-xl font-bold text-gray-900 dark:text-slate-50', titleClass)}>{title}</h3>
                  )}
                  {description && (
                    <p
                  ...
                  {callToAction && (
                    <CTA
                      ...
                      linkClass={twMerge(
                        ...
                        } text-primary font-bold text-primary-700 hover:underline dark:text-gray-200 cursor-pointer`,
                        actionClass,
                      )}
                    />
                  )}
